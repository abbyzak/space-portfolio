      ...
      <div className="w-full h-full flex items-center justify-between m-auto px-[10px]">
        ...
        <div className="hidden md:flex w-[600px] h-full flex-row items-center justify-between md:mr-20">
          <div className="flex items-center justify-between w-full h-auto border-[rgba(112,66,248,0.38)] bg-[rgba(3,0,20,0.37)] mr-[15px] px-[20px] py-[10px] rounded-full text-gray-200">
            ...
            <Link
              href={LINKS.bookCall}
              className="bg-gradient-to-r from-purple-500 to-cyan-500 px-4 py-2 rounded-full text-white font-semibold hover:from-purple-600 hover:to-cyan-600 transition"
            >
              Book a Call
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-[65px] left-0 w-full bg-[#030014] p-5 flex flex-col items-center text-gray-300 md:hidden">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <Link
              href={LINKS.bookCall}
              className="bg-gradient-to-r from-purple-500 to-cyan-500 px-6 py-3 rounded-full text-white font-semibold hover:from-purple-600 hover:to-cyan-600 transition text-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Book a Call
            </Link>
